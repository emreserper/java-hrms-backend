...
public class BMVKPSPublicSoap
{
    ...
    public BMVKPSPublicSoap(){}

    public BMVKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public BMVKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        BMVExtendedSoapSerializationEnvelope envelope= new BMVExtendedSoapSerializationEnvelope(BMVExtendedSoapSerializationEnvelope.VER11);

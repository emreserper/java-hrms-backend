...
public class BMVExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(BMVDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new BMVStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static BMVDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static BMVDateTimeConverter dateTimeConverter = new BMVStandardDateTimeConverter();

    public BMVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public BMVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new BMVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=BMVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,BMVExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=BMVHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
